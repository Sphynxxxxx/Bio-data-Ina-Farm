                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-checkbox">
                            ...
                            <div class="other-specify-field" style="margin-top: 8px; display: none;">
                                <input type="text" name="employment_type_other" class="form-control" placeholder="Please specify">
                            </div>
                        </div>
                    </div>
