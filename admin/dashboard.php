...
<head>
    ...
    <title>Admin Bio-Data Management System</title>
...
<body>
    ...
    <div class="container my-5">
        <div class="text-center mb-5">
            <h2>ADMIN Bio-Data Management System</h2>
            ...
            <div class="col-md-6">
                <div class="card shadow">
                    ...
                    <div class="card-body text-center">
                        ...
                        <a href="internship_view.php" class="btn btn-primary btn-lg">Fill Internship Form</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card shadow">
                    ...
                    <div class="card-body text-center">
                        ...
                        <a href="view.php" class="btn btn-primary btn-lg">Fill NMIS Form</a>
                    </div>
                </div>
            </div>
        </div>
